...
2. **Draw a diagram**: Use ASCII art to show the flow, structure, or relationships. If the user asks for a rendered diagram, fall back to Mermaid rendered to PNG with `mmdc -i diagram.mmd -o diagram.png`.
